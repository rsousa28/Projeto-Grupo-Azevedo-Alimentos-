 ...
 * Uses native Web Crypto API for secure hashing with a robust pure JS fallback.
 */
...
export async function sha256(message: string): Promise<string> {
  ...
  try {
    ...
    console.warn("Native subtle crypto failed, falling back to pure-JS sha256:", err);
  }
